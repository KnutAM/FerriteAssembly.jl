...
buffer = setup_domainbuffer(GridDomain(dh, material_el, cellvalues)) #hide
assembler_ref = start_assemble(K_ref, r_ref)
work!(assembler_ref, buffer; anew=a_ref) #hide
@test K ≈ K_ref    #hide
nothing;           #hide
