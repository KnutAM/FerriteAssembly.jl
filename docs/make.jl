...
makedocs(;
    ...
    draft=draft,
    # When building as draft, no scripts or notebooks are generated by Literate,
    # so the links to those in the generated markdown files are dangling.
    warnonly = draft ? [:cross_references] : false,
)
